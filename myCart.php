...
{                            
    ...
    {
        $session_array_id=array_column($_SESSION['myCart'],"name");
        if(!in_array($_GET['name'],$session_array_id))
        {
            ...
            $_SESSION['myCart'][]=$session_array1;
        }
    }
    else
    {
                    ...
                    <div class="card h-100 " >
                        <div class="row">
                            <table class="table table-hover table-fixed ">
                                ...
                                <th><div class="w-100">Quantity</div></th>
                                <th></th>
                                </tr></thead>
                            ...
                            if(!empty($_SESSION['myCart'])){
                                foreach($_SESSION['myCart'] as $key =>$value){ ?>
                                    ...
                                    <td><div class="w-100"><?=$value['quantity'];?></div></td>
                                    
                                    <td><a href="myCart.php?action=remove&name=<?=$value['name'];?>">
                            ...
                            <tr><td colspan="3"></td><td><a href="myCart.php?action=clearall">
                                        <button class="btn btn-danger">Clear</button></a></td>
                                    <td><button class="btn btn-danger">Place Order</button></td></tr></tbody>
                              </table>      
                        </div>
                    </div>
                </div>
